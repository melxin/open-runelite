...
public enum FairyRingLocation
{
	...
	public static final Supplier<RS2Widget> CONFIRM_WIDGET = () -> RS2Widgets.get(WidgetInfo.FAIRY_RING.getGroupId(), 26);
	...
	public void setCode()
	{
		...
		{
			RS2Widgets.get(WidgetInfo.FAIRY_RING.getGroupId(), TURN_INDICES[0][0]).interact(0);
			return;
		}

		if (currentCode.charAt(1) != this.code.charAt(1))
		{
			RS2Widgets.get(WidgetInfo.FAIRY_RING.getGroupId(), TURN_INDICES[1][0]).interact(0);
			return;
		}

		if (currentCode.charAt(2) != this.code.charAt(2))
		{
			RS2Widgets.get(WidgetInfo.FAIRY_RING.getGroupId(), TURN_INDICES[2][0]).interact(0);
		}
	}
