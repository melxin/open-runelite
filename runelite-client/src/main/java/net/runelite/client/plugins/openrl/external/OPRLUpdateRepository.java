...
public class OPRLUpdateRepository implements UpdateRepository
{
	...
	public OPRLUpdateRepository(String id, URL url)
	{
		this(id, url, DEFAULT_PLUGINS_JSON_FILENAME);
	}

	public OPRLUpdateRepository(String id, URL url, String pluginsJsonFileName)
	{
		this.id = id;
		this.url = url;
