package net.runelite.client.plugins.openrl.api.rs2.providers.tabs;
...
public class RS2Tabs
{
	public static void open(Tab tab)
	{
		...
		RS2ClientScript.runScript(915, tab.getIndex());
	}

	public static boolean isOpen(Tab tab)
	{
		return Vars.getVarcInt(VarClientID.TOPLEVEL_PANEL) == Arrays.asList(Tab.values()).indexOf(tab);
	}
}