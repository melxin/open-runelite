		...
		return t ->
		{
			...
			if (interactableActions != null)
			{
				for (String action : actions)
				{
					...
					{
						if (interactableAction != null && interactableAction.equalsIgnoreCase(action))
						{
							return true;
						}
					}
		...
		return t ->
		{
			...
			if (interactableActions != null)
			{
				for (String action : actions)
				{
					for (String interactableAction : interactableActions)
					{
						if (interactableAction != null && interactableAction.toLowerCase().contains(action.toLowerCase()))
						{
							return true;
						}
					}
