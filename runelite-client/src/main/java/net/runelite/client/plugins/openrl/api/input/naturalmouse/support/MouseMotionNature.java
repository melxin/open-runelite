...
import net.runelite.client.plugins.openrl.api.input.naturalmouse.api.DeviationProvider;
import net.runelite.client.plugins.openrl.api.input.naturalmouse.api.MouseInfoAccessor;
import net.runelite.client.plugins.openrl.api.input.naturalmouse.api.NoiseProvider;
import net.runelite.client.plugins.openrl.api.input.naturalmouse.api.OvershootManager;
import net.runelite.client.plugins.openrl.api.input.naturalmouse.api.SpeedManager;
