...
public class RS2Bank extends RS2Items
{
	...
	{
		final RS2Widget settingsButton = RS2Widgets.get(WidgetInfo.BANK_SETTINGS_BUTTON);
	...
	public static void collapseTabs()
	{
		...
		{
			final Widget tab = getTabs().get(i);
	...
	{
		final RS2Widget tabContainer = RS2Widgets.getWidget(InterfaceID.Bankmain.TABS);
		...
		int tabIdx = 11 + index;
		final RS2Widget tab = tabContainer.getChild(tabIdx);
