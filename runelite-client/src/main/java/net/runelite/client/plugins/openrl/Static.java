...
import net.runelite.client.plugins.openrl.api.managers.InventoryManager;
...
public class Static
{
	...
	@Inject
	@Getter
	private static Provider<PluginListPanel> pluginListPanelProvider;
	...
	{
		invokeMenuAction(param0, param1, opcode, index, itemId, WorldView.TOPLEVEL, option, target, canvasX, canvasY);
	}
