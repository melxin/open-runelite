...
public class Vars
{
	...
	public static int getBit(int id)
	{
		return Static.getGameDataCached().getVarbitValue(id);
	}

	public static int getVarp(int id)
	{
		return Static.getGameDataCached().getVarpValue(id);
	}

	public static int getVarcInt(int varClientInt)
	{
		return Static.getGameDataCached().getVarcIntValue(varClientInt);
	}

	public static String getVarcStr(int varClientStr)
	{
		return Static.getGameDataCached().getVarcStrValue(varClientStr);
	}
