...
import net.runelite.client.plugins.openrl.api.input.naturalmouse.support.DoublePoint;
...
import net.runelite.client.plugins.openrl.api.input.naturalmouse.support.mousemotion.MouseMovement;
import net.runelite.client.plugins.openrl.api.input.naturalmouse.support.mousemotion.MovementFactory;
import net.runelite.client.plugins.openrl.api.input.naturalmouse.util.MathUtil;
...
public class MouseMotion
{
	...
	public void move(MouseMotionObserver observer) throws InterruptedException
	{
		...
		while (mousePosition.x != xDest || mousePosition.y != yDest)
		{
			...
			// Number of steps is calculated from the movement time and limited by minimal amount of steps(should have at least MIN_STEPS) and distance (shouldn't have more steps than pixels travelled)
