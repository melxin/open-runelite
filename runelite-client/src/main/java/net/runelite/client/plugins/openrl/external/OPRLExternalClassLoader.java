...
@Slf4j
class OPRLExternalClassLoader extends PluginClassLoader implements ReflectUtil.PrivateLookupableClassLoader
{
	...
	OPRLExternalClassLoader(PluginManager pluginManager, PluginDescriptor pluginDescriptor, ClassLoader parent)
	{
	...
	protected Class<?> loadClassFromDependencies(String className)
	{
		...
		final List<org.pf4j.PluginDependency> dependencies = pluginDescriptor.getDependencies();
