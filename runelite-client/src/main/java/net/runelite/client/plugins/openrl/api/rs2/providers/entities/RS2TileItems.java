...
public class RS2TileItems
{
	...
	{
		return TILE_ITEMS.all(Predicates.idEquals(ids));
	}

	public static List<RS2TileItem> getAll(String... names)
	{
		return TILE_ITEMS.all(Predicates.nameEquals(names));
	}
	...
	{
		RS2TileItem closestItem = null;
		int closestDistance = Integer.MAX_VALUE;

		final List<RS2Tile> tiles = RS2Tiles.getAll();
		for (RS2Tile tile : tiles)
		{
			final List<TileItem> groundItems = tile.getGroundItems();
			if (groundItems == null)
			{
				continue;
			}
			...
			for (TileItem tileItem : groundItems)
			{
				...
				final RS2TileItem rs2Item = new RS2TileItem(tileItem);

				if (!filter.test(rs2Item))
				{
					continue;
				}

				final int distance = tileLocation.distanceTo2D(to);
	...
	{
		return TILE_ITEMS.nearest(to, Predicates.idEquals(ids));
	}

	public static RS2TileItem getNearest(WorldPoint to, String... names)
	{
		return TILE_ITEMS.nearest(to, Predicates.nameEquals(names));
	}
	...
	{
		return TILE_ITEMS.at(tile, Predicates.idEquals(ids));
	}

	public static List<RS2TileItem> getAt(RS2Tile tile, String... names)
	{
		return TILE_ITEMS.at(tile, Predicates.nameEquals(names));
	}
	...
	{
		return TILE_ITEMS.at(RS2Tiles.getAt(worldPoint), Predicates.idEquals(ids));
	}

	public static List<RS2TileItem> getAt(WorldPoint worldPoint, String... names)
	{
		return TILE_ITEMS.at(RS2Tiles.getAt(worldPoint), Predicates.nameEquals(names));
	}
	...
	{
		return TILE_ITEMS.at(RS2Tiles.getAt(worldX, worldY, plane), Predicates.idEquals(ids));
	}

	public static List<RS2TileItem> getAt(int worldX, int worldY, int plane, String... names)
	{
		return TILE_ITEMS.at(RS2Tiles.getAt(worldX, worldY, plane), Predicates.nameEquals(names));
	}
	...
	{
		return TILE_ITEMS.surrounding(worldX, worldY, plane, radius, Predicates.idEquals(ids)).stream().findFirst().orElse(null);
	}

	public static RS2TileItem getFirstSurrounding(int worldX, int worldY, int plane, int radius, String... names)
	{
		return TILE_ITEMS.surrounding(worldX, worldY, plane, radius, Predicates.nameEquals(names)).stream().findFirst().orElse(null);
	}
	...
	{
		return TILE_ITEMS.surrounding(worldX, worldY, plane, radius, Predicates.idEquals(ids));
	}

	public static List<RS2TileItem> getSurrounding(int worldX, int worldY, int plane, int radius, String... names)
	{
		return TILE_ITEMS.surrounding(worldX, worldY, plane, radius, Predicates.nameEquals(names));
	}
	...
	{
		return TILE_ITEMS.in(area, Predicates.idEquals(ids));
	}

	protected List<RS2TileItem> within(WorldArea area, String... names)
	{
		return TILE_ITEMS.in(area, Predicates.nameEquals(names));
	}
