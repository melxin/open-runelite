...
import net.runelite.client.plugins.openrl.api.commons.HttpUtil;
...
public class GlobalCollisionMap implements CollisionMap
{
	...
	{
		final byte[] bytes = HttpUtil.readBytes(url);
		return bytes != null ? new GlobalCollisionMap(new GZIPInputStream(new ByteArrayInputStream(bytes)).readAllBytes()) : null;
	}

	public static GlobalCollisionMap loadFromResources() throws IOException
	{
