...
public class PointRandomizer
{
	...
	{
		Shape shape = Perspective.getClickbox(Static.getClient(), actor.getModel(), 0, actor.getLocalLocation().getX(), actor.getLocalLocation().getY(), Static.getClient().getPlane());
		if (shape != null)
		{
			return shape.getBounds();
		}
